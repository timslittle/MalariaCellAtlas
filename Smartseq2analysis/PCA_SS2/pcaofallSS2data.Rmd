...
mca.qc.ookoo.tmm <- edgeR::calcNormFactors(mca.qc.ookoo, method = "TMM")
#mca.qc.ooc.tmm <- edgeR::calcNormFactors(mca.qc.ooc, method = "TMM")
mca.qc.eef.tmm <- edgeR::calcNormFactors(mca.qc.eef, method = "TMM")
mca.qc.spz.tmm <- edgeR::calcNormFactors(mca.qc.spz, method = "TMM")
mca.qc.idc.tmm <- edgeR::calcNormFactors(mca.qc.idc, method = "TMM")
mca.qc.sex.tmm <- edgeR::calcNormFactors(mca.qc.sex, method = "TMM")
...
pca <- scater::plotPCA(mca.qc.tmm, colour_by = "ShortenedLifeStage2", ntop=50, exprs_values="logcounts")
pcatab <- pca$data
...
mca.qc.tmmall <- edgeR::calcNormFactors(mca.qc, method = "TMM")
